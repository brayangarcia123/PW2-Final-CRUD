...
public class Update extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(user == null){
			...
			try {
				...
				Equip prof = pm.getObjectById(Equip.class,codigoLong);
				req.setAttribute("profesor",prof);
				req.getRequestDispatcher("/WEB-INF/Views/Equip/Update.jsp").forward(req, resp);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		String descripccion = req.getParameter("descripccion");
		...
		try{
			...
			prof.setModelo(modelo);
			prof.setMarca(marca);
			prof.setFuncion(funcion);
			prof.setDescripccion(descripccion);
