...
public class insertar extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		try {
			req.getRequestDispatcher("/WEB-INF/Views/Avance/insertar.jsp").forward(req, resp);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		String facturador = req.getParameter("facturador");
		String total = req.getParameter("total");
		String tiempo = req.getParameter("tiempo");
		PersistenceManager pm = PMF.get().getPersistenceManager();
		
		Avance prof = new Avance(nombre,apellido,profesion,telefono,proyecto,avance,facturador,total,tiempo);
