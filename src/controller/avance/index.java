...
public class index extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		Query query = pm.newQuery(Avance.class);
		//query.setOrdering("nombre descending");
		List<Avance> array = (List<Avance>)query.execute("select from Avance");
		
		req.setAttribute("array", array);
		try {
			req.getRequestDispatcher("/WEB-INF/Views/Avance/index.jsp").forward(req, resp);
			query.closeAll();
