...
<body>
	...
	<div class="collapse navbar-collapse" id="navegacion">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="">MOSTRAR ROLES</a>
		</ul>
	</div>
	</nav> </header>
	...
	<div class="container">
		<div class="table-responsive  ">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td class='btn btn-group'>
						<a href="/role/update?id=<%= rol.getId() %>" class="btn btn-primary btn-sm">Modificar</a> 
			...
			<div>
			<a href="/role" class="btn btn-success">ACTUALIZAR ROLES</a>
			<br>
			</div>
