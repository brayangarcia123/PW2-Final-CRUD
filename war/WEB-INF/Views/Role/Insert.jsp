	...
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-md-6">
				...
				<form id="form1" class="form-horizontal" action="/role/insert"
					method="POST">
					<div class="form-group">
						<label class="text-info col-sm-3 control-label">Nombre del ROL</label>
						<div class="col-sm-9">
					...
					<div class="text-right">
						<button class="btn btn-success" id="enviar" type="submit">Insertar Rol</button>
					</div>
				</form>
			</div>
		</div>
